...
kiss.app.defineView("buy",function(id,target){return createPanel({id:id,target,modal:true,closable:true,draggable:true,align:"center",top:200,width:"50%",height:()=>kiss.screen.getHeightMinus(400),title:"Why should you buy this?",animation:"zoomIn",items:[{type:"html",html:`<pre class="showcase-description">Seriously.
...
`},{type:"html",html:`
            ...
            `}]})});kiss.app.defineView("logo",function(id,target){return createHtml({id:id,target,margin:"0px 0px 32px 0px",height:150,html:`<img src="./resources/img/KissJS logo.png">`,style:"cursor: pointer",events:{click:()=>{kiss.router.navigateTo({ui:"landing-page"})},mouseenter:function(){this.setAnimation("pulse")}}})});function showCase(title,description,...examples){let exampleBlock=examples.map(itemConfig=>showCaseExample(itemConfig))
return createBlock({layout:"horizontal",padding:"16px 0px 16px 0px",items:[{type:"html",html:"",class:"showcase-margin"},{width:"100%",items:[{id:title,type:"html",html:`<div class="showcase-title">${title}</div>`},{type:"html",html:`<div class="showcase-description"><pre>${marked(description)}</pre></div>`},...exampleBlock]}]})}
function showCaseExample(itemConfig){if(itemConfig.demo==true){return createBlock({id:"showcase-"+kiss.tools.shortUid(),items:[{type:"html",class:"showcase-description",html:`<iframe style="border: none" width=100% height=${itemConfig.height || 500} src="${itemConfig.url}">`}]})}
return createBlock({id:"showcase-"+itemConfig.id,layout:"horizontal",flexWrap:"wrap",items:[{flex:1,class:"showcase-example",items:[itemConfig]},{type:"html",flex:1,class:"code-sample",html:toHTML(itemConfig)}]})}
function toHTML(config){let jsonConfig=kiss.tools.snapshot(config)
...
- "switch"
- "star"`
kiss.doc.selectField=`Select fields are very powerful fields that have a bunch of cool options:
...
`;kiss.app.defineView("containers-menu",function(id,target){return createBlock({id:id,target,defaultConfig:{height:40,textAlign:"left",iconSize:"18px",iconColor:"#8aa2c8",borderColor:"#e3e5ec",borderWidth:"1px 0px 0px 0px",borderRadius:"0px",backgroundColor:"#f3f5f7",colorHover:"#00aaee",iconColorHover:"#00aaee",backgroundColorHover:"#e5e9ec"},layout:"vertical",items:[{type:"html",html:"Containers",class:"navigation-title"},{type:"button",text:"Introduction",icon:"fas fa-info",action:()=>kiss.router.navigateTo({anchor:"Introduction about containers"})},{type:"button",text:"Block",icon:"fas fa-code",action:()=>kiss.router.navigateTo({anchor:"Block"})},{type:"button",text:"Panel",icon:"fas fa-window-maximize",action:()=>kiss.router.navigateTo({anchor:"Panel"})},{type:"button",text:"Form",icon:"far fa-file-alt",action:()=>kiss.router.navigateTo({anchor:"Form"})},{type:"button",text:"Back to Home",icon:"fas fa-arrow-left",fontWeight:"bold",action:()=>kiss.router.navigateTo({section:"home",anchor:"What is KissJS?"})}]})});kiss.app.defineView("datatables-content",function(id,target){let fakeAttachmentField='[{"id":"01887414-3775-7443-81bc-260a9539d7e4","filename":"cyberpunk-cantina-Women-Cyberpunk-ZEN6auDj.png","path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-ZEN6auDj.png","size":1279664,"type":"amazon_s3","mimeType":"image/png","thumbnails":{"s":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-ZEN6auDj.64x64.png","size":6106},"m":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-ZEN6auDj.256x256.png","size":87845},"l":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-ZEN6auDj.512x512.png","size":332583}},"accessReaders":["*"],"createdAt":"2023-05-31T23:10:59.240Z","createdBy":"david.grossi@pickaform.com"},{"id":"01887414-379e-701e-b4dc-15301d8b4560","filename":"cyberpunk-cantina-Women-Cyberpunk-RUyLqAZl.png","path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-RUyLqAZl.png","size":1360256,"type":"amazon_s3","mimeType":"image/png","thumbnails":{"s":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-RUyLqAZl.64x64.png","size":6080},"m":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-RUyLqAZl.256x256.png","size":89129},"l":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-RUyLqAZl.512x512.png","size":337313}},"accessReaders":["*"],"createdAt":"2023-05-31T23:10:59.240Z","createdBy":"david.grossi@pickaform.com"},{"id":"01887414-378a-759d-b17d-762b4dd33b72","filename":"cyberpunk-cantina-Women-Cyberpunk-vfNB7pxJ.png","path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-vfNB7pxJ.png","size":1301698,"type":"amazon_s3","mimeType":"image/png","thumbnails":{"s":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-vfNB7pxJ.64x64.png","size":6193},"m":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-vfNB7pxJ.256x256.png","size":89664},"l":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-vfNB7pxJ.512x512.png","size":331588}},"accessReaders":["*"],"createdAt":"2023-05-31T23:10:59.240Z","createdBy":"david.grossi@pickaform.com"},{"id":"01887414-506f-7707-a529-20a36858b1a8","filename":"cyberpunk-cantina-Women-Cyberpunk-FjFuk2YX.png","path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-FjFuk2YX.png","size":1357025,"type":"amazon_s3","mimeType":"image/png","thumbnails":{"s":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-FjFuk2YX.64x64.png","size":6136},"m":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-FjFuk2YX.256x256.png","size":89761},"l":{"path":"https://pickaform-europe.s3.eu-west-3.amazonaws.com/files/01844399-988f-7974-a68f-92d35fc702cc/2023/06/01/cyberpunk-cantina-Women-Cyberpunk-FjFuk2YX.512x512.png","size":339784}},"accessReaders":["*"],"createdAt":"2023-05-31T23:10:59.240Z","createdBy":"david.grossi@pickaform.com"}]';fakeAttachmentField=JSON.parse(fakeAttachmentField)
localStorage.setItem("config-layout-attachment","thumbnails-large")
let fakeModel=new kiss.data.Model({id:"fake",name:"Computer game",namePlural:"Computer games",icon:"fas fa-rocket",items:[{type:"panel",title:"General informations",icon:"fas fa-info-circle",collapsible:true,defaultConfig:{labelPosition:"left",fieldWidth:"100%",labelWidth:"30%"},items:[{primary:true,id:"gameName",label:"Video game name",type:"text",value:"Cyberpunk"},{id:"releaseDate",label:"Release date",type:"date",value:"today"},{id:"reviewed",label:"Reviewed",type:"checkbox",checked:true},{id:"category",label:"Category",type:"select",multiple:true,value:"RPG",options:[{value:"Adventure",color:"#00aaee"},{value:"Action",color:"#00eeaa"},{value:"Strategy",color:"#88cc00"},{value:"TPS",color:"#aa00ee"},{value:"FPS",color:"#eeaa00"},{value:"RPG",color:"#ee00aa"},{value:"RTS",color:"#00aaee"},{value:"Simulation",color:"#2bc48c"}]},{id:"platform",label:"Platform",type:"select",value:"PS4",options:[{value:"PS5",color:"#0075ff"},{value:"PS4",color:"#00aaee"},{value:"PS3",color:"#00eeaa"},{value:"Xbox",color:"#aaee00"},{value:"Switch",color:"#aa00ee"},{value:"Xbox one",color:"#eeaa00"},{value:"PC",color:"#000000"},{value:"IOS",color:"#999999"}]},{id:"description",label:"Description",type:"textarea",rows:10},{id:"attachment",label:"Game screenshots",type:"attachment",value:fakeAttachmentField,tip:{text:"Sorry, attachment field is not enabled in demo mode",maxWidth:500}}]},{type:"panel",title:"Details",icon:"fas fa-star",collapsible:true,defaultConfig:{labelPosition:"left",fieldWidth:"100%",labelWidth:"30%"},items:[{id:"duration",label:"Duration",type:"number",min:1,max:100,unit:"hour",precision:0,tip:"Duration must be between 1 and 100"},{id:"ratingMetacritic",label:"Metacritic",type:"rating",shape:"star",max:5},{id:"ratingIGN",label:"IGN",type:"rating",shape:"thumb",max:8,iconColorOn:"#00aaee"},{id:"ratingGameSpot",label:"GameSpot",type:"rating",shape:"heart",max:3,iconColorOn:"var(--red)"},{id:"percentFinished",label:"Game finished",type:"slider",unit:"%",value:50},{id:"color",label:"Color code",type:"color",value:"#00aaee"},{id:"icon",label:"Icon code",type:"icon",value:"fab fa-apple"}]}]})
let fakeCollection=fakeModel.collection
let columns=fakeModel.getFieldsAsColumns()
columns.push({type:"button",text:"View",width:50,button:{tip:"Custom button example",icon:"fas fa-eye",action:(rowIndex,colIndex,recordId,record)=>{log(record)
let recordToHtml=`<h2>Record clicked</h2><font style="font-family: sans-serif">`+toHTML(record)+"</font>"
createNotification({message:recordToHtml,width:1000,duration:2000})}}})
columns.push({type:"button",width:140,button:{text:"Other button",action:(rowIndex,colIndex,recordId,record)=>{createNotification({message:"Record id: "+recordId})}}})
kiss.selection.reset("myDatatable")
let datatable=createDatatable({id:"myDatatable",color:"#00aaee",collection:fakeCollection,columns,canEdit:true,canAddField:false,canEditField:false,canCreateRecord:true,height:()=>kiss.screen.current.height-50,actions:["-",{text:"Sort by Category (asc) and Platform (desc)",icon:"fas fa-sort",action:()=>{$("myDatatable").sortBy([{category:"asc"},{platform:"desc"}])}},{text:"Group by Category and Platform",icon:"far fa-clone",action:()=>{$("myDatatable").groupBy(["category","platform"])}},{text:"Add 1000 records...",icon:"fas fa-database",action:()=>{fakeCollection.hasChanged=true
fakeCollection.insertFakeRecords(1000).then(()=>kiss.pubsub.publish("EVT_RECORDS_LOADED"))}},{text:"Show selection in the console",icon:"fas fa-check",action:()=>{log("pickaform - Selected records:",0,$("myDatatable").getSelectedRecords())}},{icon:"fa fa-download",text:txtTitleCase("Download selection as JSON"),action:async()=>{let selectedRecords=$("myDatatable").getSelectedRecords()
let exportRecords=[]
for(let record of selectedRecords)exportRecords.push(await record.getData())
let textFile=JSON.stringify(exportRecords)
let blob=new Blob([textFile],{type:"application/json"})
let url=URL.createObjectURL(blob)
let sourceUrl=`<br><br><center><a href="${url}" download="export.json">${txtTitleCase("download file")}</a></center>`
createDialog({type:"message",title:txtTitleCase("Download selection as JSON"),message:txtTitleCase("Click on the link to download your JSON file")+sourceUrl,buttonOKText:txtTitleCase("Done")})}}],methods:{selectRecord:async(record)=>createForm(record,fakeModel),async createRecord(model){record=model.create()
const success=await record.save()
if(!success)return
createForm(record)}},subscriptions:{EVT_RECORDS_LOADED:async function(){await this.collection.find()
this._renderTable()
createDialog({type:"message",title:"Records inserted!",message:"This datatable has "+this.collection.count+" rows (including group rows)"})}}})
return createBlock({id:id,target,style:"user-select: none; background: #ffffff;",height:"100%",items:[datatable],methods:{load:()=>{fakeCollection.insertFakeRecords(5000).then(()=>kiss.pubsub.publish("EVT_RECORDS_LOADED"))}}})});kiss.doc.datatables=`
KissJS datatables are really powerful and fast components to display your data.
`;kiss.app.defineView("datatables-menu",function(id,target){return createBlock({id:id,target,defaultConfig:{height:40,textAlign:"left",iconSize:"18px",iconColor:"#8aa2c8",borderColor:"#e3e5ec",borderWidth:"1px 0px 0px 0px",borderRadius:"0px",backgroundColor:"#f3f5f7",colorHover:"#00aaee",iconColorHover:"#00aaee",backgroundColorHover:"#e5e9ec"},layout:"vertical",items:[{type:"html",html:"Datatables",class:"navigation-title"},{type:"button",text:"Example with 5000 records",icon:"fas fa-info",action:()=>kiss.router.navigateTo({anchor:"Introduction about KissJS datatables"})},{type:"button",text:"Back to Home",icon:"fas fa-arrow-left",fontWeight:"bold",action:()=>kiss.router.navigateTo({ui:"start",section:"home"})}]})});kiss.app.defineView("home-content",function(id,target){return createBlock({id:id,target,styles:{"this":"user-select: none; background: #ffffff"},items:[showCase("What is KissJS?",kiss.doc.concepts),showCase("Philosophy",kiss.doc.philosophy),showCase("Efficiency",kiss.doc.efficiency),showCase("Dumb code",kiss.doc.dumbCode),showCase("Features",kiss.doc.features),showCase("Technically",kiss.doc.technically),showCase("Quickstart",kiss.doc.quickstart),showCase("Coding style",kiss.doc.codingStyle),showCase("About the author's beliefs",kiss.doc.beliefs)]})});kiss.doc.concepts=`
...
`;kiss.app.defineView("home-menu",function(id,target){return createBlock({id:id,target,defaultConfig:{height:40,color:"#667788",colorHover:"#00aaee",backgroundColor:"#f3f5f7",backgroundColorHover:"#e5e9ec",textAlign:"left",iconSize:"18px",iconColor:"#8aa2c8",iconColorHover:"#00aaee",borderColor:"#e3e5ec",borderWidth:"1px 0px 0px 0px",borderRadius:"0px"},layout:"vertical",items:[{type:"html",html:"Home",class:"navigation-title"},{type:"button",text:"Introduction",icon:"fas fa-star",action:()=>kiss.router.navigateTo({anchor:"What is KissJS?"})},{type:"button",text:"Philosophy",icon:"fas fa-heart",action:()=>kiss.router.navigateTo({anchor:"Philosophy"})},{type:"button",text:"Efficiency",icon:"fas fa-fighter-jet",action:()=>kiss.router.navigateTo({anchor:"Efficiency"})},{type:"button",text:"Dumb code",icon:"fas fa-smile fa-rotate-180",action:()=>kiss.router.navigateTo({anchor:"Dumb code"})},{type:"button",text:"Features",icon:"fas fa-list",action:()=>kiss.router.navigateTo({anchor:"Features"})},{type:"button",text:"Technically",icon:"fas fa-wrench",action:()=>kiss.router.navigateTo({anchor:"Technically"})},{type:"button",text:"Quickstart",icon:"fas fa-bolt",action:()=>kiss.router.navigateTo({anchor:"Quickstart"})},{type:"button",text:"Coding style",icon:"fas fa-thumbs-up",action:()=>kiss.router.navigateTo({anchor:"Coding style"})},{type:"button",text:"About the author's beliefs",icon:"fas fa-eye",action:()=>kiss.router.navigateTo({anchor:"About the author's beliefs"})},{type:"button",text:"UI Components",icon:"fas fa-cube",iconColor:"#8c4bff",action:()=>kiss.router.navigateTo({section:"components",anchor:"Introduction about KissJS components"})},{type:"button",text:"UI Datatables",icon:"fas fa-table",iconColor:"#8c4bff",action:()=>kiss.router.navigateTo({section:"datatables",anchor:"Introduction about KissJS datatables"})},{type:"button",text:"UI Containers",icon:"far fa-clone",iconColor:"#8c4bff",action:()=>kiss.router.navigateTo({section:"containers",anchor:"Introduction about KissJS containers"})},{type:"button",text:"Tutorials",icon:"fas fa-user-graduate",iconColor:"#bb22ff",action:()=>kiss.router.navigateTo({section:"tutorials"})},{type:"button",text:"<b><u>API DOCUMENTATION</u></b>",color:"#8aa2c8",icon:"fas fa-coffee",action:()=>document.location="../../doc/out/kiss.html"}]})});kiss.app.defineView("start",function(id,target){return createBlock({id:id,target,fullscreen:true,width:"100%",margin:"auto",layout:"vertical",items:[{id:"site-topbar",items:[{type:"view",id:"topbar"}]},{flex:1,layout:"horizontal",items:[{id:"site-west",class:"navigation-panel",height:"100%",layout:"vertical",items:[{type:"view",id:"logo",},{id:"site-navigation",overflowY:"auto"}]},{id:"site-content",flex:1,height:"100%",overflowY:"auto"}]}],subscriptions:{EVT_ROUTE_UPDATED:(msgData)=>{if(kiss.router.getRoute().ui=="start"){let newSection=msgData.section
let newAnchor=decodeURI(msgData.anchor)
if(newSection){let navigation=kiss.views.show(newSection+"-menu","site-navigation",true)
...
if(kiss.context.navigation=="hidden")$("site-west").hide()}},EVT_WINDOW_RESIZED:(msgData)=>{if(kiss.router.getRoute().ui=="start"){if(msgData.current.width<1650){kiss.context.navigation="hidden"
$("side-menu").show()
$("site-west").style.position="fixed"
$("site-west").style.zIndex=1000
$("site-west").hide()}
else{kiss.context.navigation="visible"
$("side-menu").hide()
$("site-west").style.position="relative"
$("site-west").show()}}}}})});kiss.app.defineView("demo-panel",function(id,target){return createPanel({id:id,target,title:"I'm a demo panel",icon:"fas fa-check",boxShadow:"4px 4px 16px #aaaaaa",closable:true,closeMethod:"hide",draggable:true,headerBackgroundColor:"linear-gradient(45deg, rgba(98,9,255,1) 0%, rgba(140,75,255,1) 100%)",width:550,left:"50%",verticalAlign:"center",layout:"vertical",defaultConfig:{labelPosition:"left",labelWidth:"250px",fieldWidth:"100%"},items:[{id:"First name",type:"text",label:"First name",placeholder:"Enter your first name",events:{change:()=>publish("DATA_HAS_CHANGED")}},{id:"Last name",type:"text",label:"Last name",value:"SMITH (just a default value)",events:{change:()=>publish("DATA_HAS_CHANGED")}},{id:"Today is...",type:"date",label:"Today is...",value:new Date().toISO(),events:{change:()=>publish("DATA_HAS_CHANGED")}},{id:"Your favorite addictions",type:"select",label:"Your favorite addictions",allowClickToDelete:true,allowSwitchOnOff:true,multiple:true,value:["Kissing"],options:[{value:"Angularing",color:"#00aaee"},{value:"Reacting",color:"#3bc48c"},{value:"Vueing",color:"#cc3300"},{value:"Kissing",color:"#ff9955"}],events:{change:()=>publish("DATA_HAS_CHANGED")}},{id:"Show random text",type:"checkbox",label:"Show random text",iconColorOn:"#00aaee",shape:"switch",events:{change:function(){let dumbHtml=$("dumb-text")
let dumbText=kiss.db.faker("description")
if(this.getValue()==true){dumbHtml.setInnerHtml(dumbText)
dumbHtml.setAnimation("zoomIn").show()}else dumbHtml.hide()
publish("DATA_HAS_CHANGED")}}},{id:"dumb-text",type:"html",hidden:true},{id:"data",type:"textarea",label:"Form data",rows:10,subscriptions:{DATA_HAS_CHANGED:function(){const formData=$(id).getData(true)
delete formData.data
const formDataAsString=JSON.stringify(formData,null,4)
this.setValue(formDataAsString)}}},{layout:"horizontal",margin:"20px 0px 0px 0px",width:"100%",defaultConfig:{flex:1,margin:"5px",borderRadius:"32px",color:"#ffffff",iconColor:"#ffffff",iconSize:"14px",padding:"8px 10px 8px 10px"},items:[{type:"button",text:"Click to swing!",backgroundColor:"#2e1d80",backgroundColorHover:"#4e3da0",icon:"fas fa-sync-alt",action:(event)=>{if(!$("demo-panel"))kiss.views.show("demo-panel")
$("demo-panel").setAnimation({name:"swing",speed:"fast"})}},{type:"button",text:"Click to shake!",backgroundColor:"#8c4bff",backgroundColorHover:"#bc7bff",icon:"fas fa-arrows-alt-h",action:(event)=>{if(!$("demo-panel"))kiss.views.show("demo-panel")
$("demo-panel").setAnimation({name:"shakeX",speed:"fast"})}},{type:"button",text:"Squeeze that code",backgroundColor:"#00aaee",backgroundColorHover:"#30dafe",icon:"fas fa-star",action:(event)=>{$("code-example").scrollIntoView({behavior:"smooth"})
$("code-example").setAnimation({name:"jello",speed:"slow"})}}]}]})});kiss.app.defineView("landing_features",function(id,target){return createBlock({id:id,target,width:"100%",height:500,margin:"0px 0px 50px 0px",defaultConfig:{padding:"32px",margin:"0px 32px 0px 32px",background:"#ffffff",borderRadius:"10px",boxShadow:"0px 0px 20px #cccccc"},layout:"horizontal",items:[{flex:1,type:"html",html:"HELLO"},{flex:1,type:"html",html:"WORLD"}]})});kiss.app.defineView("landing-hero",function(id,target){return createBlock({id:id,target,layout:"vertical",alignItems:"center",animation:"rotateIn",height:"100%",items:[{type:"spacer",flex:1},{type:"html",flex:1,html:`<div class="spacer"></div>
                            <div class="home-title">KISS JS</div>
                            <div class="home-pitchline">Simple Javascript UI library</div>`.removeExtraSpaces()},{defaultConfig:{color:"#ffffff",fontSize:"1.5vw",icon:"fas fa-chevron-down",iconHover:"fas fa-paper-plane",iconSize:"1.5vw",iconColor:"#ffffff",margin:"5% 0% 0% 0%",padding:"1vw",height:"4vw",borderWidth:"0.1vw",borderRadius:"3vw",animation:"zoomIn",width:"33%"},layout:"horizontal",items:[{type:"button",text:"Quick overview",backgroundColor:"#2e1d80",backgroundColorHover:"#4e3da0",action:()=>{$("code-example").scrollIntoView({behavior:"smooth"})
if(!$("demo-panel"))kiss.views.show("demo-panel")}},{type:"spacer",width:"2vw"},{type:"button",text:"Datatable and forms",backgroundColor:"#00aaee",backgroundColorHover:"#30dafe",action:()=>{kiss.router.navigateTo({ui:"start",section:"datatables"})}},{type:"spacer",width:"2vw"},{type:"button",text:"Quick guide",backgroundColor:"#8c4bff",backgroundColorHover:"#bc7bff",action:()=>{kiss.router.navigateTo({ui:"start",section:"home"})}},{type:"spacer",width:"2vw"},{type:"button",text:"API documentation",backgroundColor:"#ed3757",backgroundColorHover:"#ff5777",action:()=>document.location="../doc/out/kiss.html"}]},{type:"spacer",flex:1}]})});kiss.app.defineView("landing-page",function(id,target){return createBlock({id:id,target,fullscreen:true,overflowY:"auto",items:[{type:"view",id:"landing-hero"},{type:"view",id:"landing-sample-code"}],methods:{load:function(){$("demo-code").innerHTML=texts.showPanelConfig
...
$(id).onscroll=(event)=>{let pagePosition=$(id).scrollTop
let demoPosition=$("landing-sample-code").offsetTop
if(pagePosition>(demoPosition-512)){kiss.views.show("demo-panel")
if($("demo-panel").isHidden())$("demo-panel")?.show().setAnimation("zoomIn")}else{if($("demo-panel")&&!$("demo-panel").isHidden())$("demo-panel").hide()}}}}})});kiss.app.defineView("landing-sample-code",function(id,target){texts.showPanelConfig=`<span id="help-simple-api" class="code-help">createPanel</span>({
        id: "demo-panel",
...
return createBlock({id:id,target,class:"craft-background",layout:"vertical",items:[{id:"code-example",type:"html",class:"code-feature",html:`<div class="stripe-title">Write dumb code.<br>Get results.</div>
                <pre id="demo-code" class="code-sample"></pre>
                `}]})});kiss.app.defineView("tutorials-content",function(id,target){return createBlock({id:id,target,styles:{"this":"user-select: none;"},items:[{background:"#ffffff",defaultConfig:{labelWidth:200,labelPosition:"left"},items:[showCase(kiss.doc.tutorial_01_title,kiss.doc.tutorial_01,{demo:true,url:"../tutorial_01/index.html"}),showCase(kiss.doc.tutorial_02_title,kiss.doc.tutorial_02,{demo:true,url:"../tutorial_02/index.html"}),showCase(kiss.doc.tutorial_03_title,kiss.doc.tutorial_03,{demo:true,url:"../tutorial_03/index.html"}),showCase(kiss.doc.tutorial_04_title,kiss.doc.tutorial_04,{demo:true,url:"../tutorial_04/index.html"}),showCase(kiss.doc.tutorial_05_title,kiss.doc.tutorial_05),showCase(kiss.doc.tutorial_06_title,kiss.doc.tutorial_06,{demo:true,url:"../tutorial_06/index.html"}),showCase(kiss.doc.tutorial_09_title,kiss.doc.tutorial_09,{demo:true,height:800,url:"../tutorial_09/index.html"}),showCase(kiss.doc.tutorial_10_title,kiss.doc.tutorial_10,{demo:true,height:800,url:"../tutorial_10/index.html"})]}]})});kiss.doc.tutorial_01_title="01 - Using UI components"
kiss.doc.tutorial_01=`KissJS comes with a few pre-built components that will help you build a user interface **programmatically**.
...
kiss.doc.tutorial_02=`When you create a Web application, you generally need multiple **views**.
...
kiss.doc.tutorial_03=`We've seen before that a KissJS **view** must return an **HTMLElement**.
...
kiss.doc.tutorial_04=`In some situations, putting all the logic directly inside the view definition can lead to long scripts that are difficult (and boring) to maintain.
...
kiss.doc.tutorial_05=`KissJS **client router** is a very convenient way to **navigate between views**.
...
kiss.doc.tutorial_06=`PubSub stands for **Publish/Subscribe** and is a core mechanism used by KissJS to establish communication between components.
...
kiss.doc.tutorial_09=`Yes. Tuto 07 and 08 were eaten by a quantic vortex. They are on their way back. Soon.
...
kiss.doc.tutorial_10=`Our **talking blocks** are an interesting way to teach object oriented programming to beginners.
...
On top of this, the demo makes extensive use of async/await to keep the logic in sync with the asynchronous animations.`;kiss.app.defineView("tutorials-menu",function(id,target){return createBlock({id:id,target,defaultConfig:{height:40,textAlign:"left",iconSize:"18px",iconColor:"#8aa2c8",borderColor:"#e3e5ec",borderWidth:"1px 0px 0px 0px",borderRadius:"0px",backgroundColor:"#f3f5f7",colorHover:"#00aaee",iconColorHover:"#00aaee",backgroundColorHover:"#e5e9ec"},layout:"vertical",items:[{type:"view",id:"logo"},{type:"html",html:"Tutorials & demos",class:"navigation-title"},{type:"button",text:kiss.doc.tutorial_01_title,icon:"fas fa-user-graduate",action:()=>kiss.router.navigateTo({anchor:kiss.doc.tutorial_01_title})},{type:"button",text:kiss.doc.tutorial_02_title,icon:"fas fa-user-graduate",action:()=>kiss.router.navigateTo({anchor:kiss.doc.tutorial_02_title})},{type:"button",text:kiss.doc.tutorial_03_title,icon:"fas fa-user-graduate",action:()=>kiss.router.navigateTo({anchor:kiss.doc.tutorial_03_title})},{type:"button",text:kiss.doc.tutorial_04_title,icon:"fas fa-user-graduate",action:()=>kiss.router.navigateTo({anchor:kiss.doc.tutorial_04_title})},{type:"button",text:kiss.doc.tutorial_05_title,icon:"fas fa-user-graduate",action:()=>kiss.router.navigateTo({anchor:kiss.doc.tutorial_05_title})},{type:"button",text:kiss.doc.tutorial_06_title,icon:"fas fa-user-graduate",action:()=>kiss.router.navigateTo({anchor:kiss.doc.tutorial_06_title})},{type:"button",text:kiss.doc.tutorial_09_title,icon:"fas fa-user-graduate",action:()=>kiss.router.navigateTo({anchor:kiss.doc.tutorial_09_title})},{type:"button",text:kiss.doc.tutorial_10_title,icon:"fas fa-user-graduate",action:()=>kiss.router.navigateTo({anchor:kiss.doc.tutorial_10_title})},{type:"button",text:"Back to Home",icon:"fas fa-arrow-left",fontWeight:"bold",action:()=>kiss.router.navigateTo({section:"home",anchor:"What is KissJS?"})}]})});