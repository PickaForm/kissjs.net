...
document.querySelectorAll("link").forEach(link=>{if(link.href.indexOf("styles/colors")!=-1){link.href="https://kissjs.net/resources/lib/kissjs/styles/colors/"+color+".css"}})}else{let theme=localStorage.getItem("config-theme")
if(!theme)return
theme=JSON.parse(theme)
Object.keys(theme).forEach(variable=>{const color=theme[variable]
document.documentElement.style.setProperty(variable,color)})}}
if(geometry){document.querySelectorAll("link").forEach(link=>{if(link.href.indexOf("styles/geometry")!=-1){link.href="https://kissjs.net/resources/lib/kissjs/styles/geometry/"+geometry+".css"}})}
