...
return}
config.undo()}})}};kiss.views={views:{},viewBuilders:{},viewControllers:{},cachedNodes:{},addView(id,builder){this.viewBuilders[id]=builder},addViewController(id,controller){this.viewControllers[id]=controller},buildView(id,target){if(!this.views[id]){try{log(`kiss.views - buildView - Building view ${id}`)
