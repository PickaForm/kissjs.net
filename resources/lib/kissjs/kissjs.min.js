...
if(meta.title){if(typeof meta.title=="string"){document.title=meta.title}
else{let title=meta.title[kiss.language.current]
if(title)document.title=title}}
Object.keys(meta).forEach(name=>{if(name=="title")return
if(typeof meta[name]=="string"){this._injectMetaTag(name,meta[name])}
else{let metaString=meta[name][kiss.language.current]
if(metaString)this._injectMetaTag(name,metaString)}})},_injectMetaTag(name,value){let metaTag=document.querySelector('meta[name="'+name+'"]')
if(metaTag){metaTag.setAttribute("content",value)}else{metaTag=document.createElement("meta")
metaTag.setAttribute("name",name)
metaTag.setAttribute("content",value)
document.head.appendChild(metaTag)}},reset(viewId,target,exclusive){const view=kiss.views.get(viewId)
...
const logoUrl=(kiss.global.absolutePath)?kiss.global.absolutePath+"/client/pickaform/resources/img/ICON_32x32_Logo.png":"./resources/img/ICON_32x32_Logo.png"
let filePicker
