...
if(view&&(!view.isConnected||view.hidden)){if(this.getCachedNode(id)!=null){log("kiss.views - The view **was** in cache: "+id)}else{log("kiss.views - The view **was not** in cache: "+id)}
view.render(target)
