...
break
default:this._injectMetaTag("name",name,meta,name)}})},_injectMetaTag(propertyType,propertyName,meta,name){let metaTag=document.querySelector('meta['+propertyType+'="'+propertyName+'"]')
