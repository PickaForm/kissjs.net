"use strict";const kiss={$KissJS:"KissJS - Keep It Simple Stupid Javascript",build:2815,isClient:true,db:{},ux:{},doc:{},app:{},acl:{},ajax:{},cache:{},tools:{},views:{},theme:{},global:{},screen:{},router:{},loader:{},pubsub:{},plugins:{},context:{},session:{},formula:{},undoRedo:{},webfonts:{},language:{},directory:{},selection:{},templates:{},websocket:{},loadingSpinner:{},addToModule:function(moduleName,methods){Object.assign(kiss[moduleName],methods)},ui:{},data:{Model:{},Collection:{},Record:{},Transaction:{},trash:{},addMethodToAllModels(methodName,method){Object.values(kiss.data.Record).forEach(recordClass=>{recordClass.prototype[methodName]=method})},addPropertyToAllModels(propertyName,getter){Object.values(kiss.data.Record).forEach(recordClass=>{Object.defineProperty(recordClass.prototype,propertyName,{get:function(){try{return getter(this)}catch(err){log("kiss.data.Model - addPropertyToAllModels",4,err)
...
document.querySelectorAll("link").forEach(link=>{if(link.href.indexOf("styles/colors")!=-1){if(kiss.global.absolutePath){link.href=kiss.global.absolutePath+"/kissjs/client/ui/styles/colors/"+color+".css"}else{if(pickaform){link.href="../../kissjs/client/ui/styles/colors/"+color+".css"}
...
if(geometry){document.querySelectorAll("link").forEach(link=>{if(link.href.indexOf("styles/geometry")!=-1){if(kiss.global.absolutePath){link.href=kiss.global.absolutePath+"/kissjs/client/ui/styles/geometry/"+geometry+".css"}else{if(pickaform){link.href="../../kissjs/client/ui/styles/geometry/"+geometry+".css"}
