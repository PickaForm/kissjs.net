...
kiss.app.defineView({id:"buy",renderer:function(id,target){return createPanel({id:id,target,modal:true,closable:true,draggable:true,align:"center",top:200,width:"50%",height:()=>kiss.screen.getHeightMinus(400),title:"Why should you buy this?",animation:"zoomIn",items:[{type:"html",html:`<pre class="showcase-description">Seriously.
...
`;kiss.app.defineView({id:"datatables-menu",renderer:function(id,target){return createBlock({id:id,target,defaultConfig:{height:40,textAlign:"left",iconSize:"18px",iconColor:"#8aa2c8",borderColor:"#e3e5ec",borderWidth:"1px 0px 0px 0px",borderRadius:"0px",backgroundColor:"#f3f5f7",colorHover:"#00aaee",iconColorHover:"#00aaee",backgroundColorHover:"#e5e9ec"},layout:"vertical",items:[{type:"html",html:"Datatables",class:"navigation-title"},{type:"button",text:"Example with 5000 records",icon:"fas fa-info",action:()=>kiss.router.navigateTo({anchor:"Introduction about KissJS datatables"})},{type:"button",text:"Back to Home",icon:"fas fa-arrow-left",fontWeight:"bold",action:()=>kiss.router.navigateTo({ui:"start",section:"home"})}]})}});kiss.app.defineView({id:"home-content",renderer:function(id,target){return createBlock({id:id,target,styles:{"this":"user-select: none; background: #ffffff"},items:[showCase("What is KissJS?",kiss.doc.concepts),showCase("Philosophy",kiss.doc.philosophy),showCase("Efficiency",kiss.doc.efficiency),showCase("Dumb code",kiss.doc.dumbCode),showCase("Features",kiss.doc.features),showCase("Technically",kiss.doc.technically),showCase("Quickstart",kiss.doc.quickstart),showCase("Coding style",kiss.doc.codingStyle),showCase("About the author's beliefs",kiss.doc.beliefs)]})}});kiss.doc.concepts=`
...
`;kiss.app.defineView({id:"home-menu",renderer:function(id,target){return createBlock({id:id,target,defaultConfig:{height:40,color:"#667788",colorHover:"#00aaee",backgroundColor:"#f3f5f7",backgroundColorHover:"#e5e9ec",textAlign:"left",iconSize:"18px",iconColor:"#8aa2c8",iconColorHover:"#00aaee",borderColor:"#e3e5ec",borderWidth:"1px 0px 0px 0px",borderRadius:"0px"},layout:"vertical",items:[{type:"html",html:"Home",class:"navigation-title"},{type:"button",text:"Introduction",icon:"fas fa-star",action:()=>kiss.router.navigateTo({anchor:"What is KissJS?"})},{type:"button",text:"Philosophy",icon:"fas fa-heart",action:()=>kiss.router.navigateTo({anchor:"Philosophy"})},{type:"button",text:"Efficiency",icon:"fas fa-fighter-jet",action:()=>kiss.router.navigateTo({anchor:"Efficiency"})},{type:"button",text:"Dumb code",icon:"fas fa-smile fa-rotate-180",action:()=>kiss.router.navigateTo({anchor:"Dumb code"})},{type:"button",text:"Features",icon:"fas fa-list",action:()=>kiss.router.navigateTo({anchor:"Features"})},{type:"button",text:"Technically",icon:"fas fa-wrench",action:()=>kiss.router.navigateTo({anchor:"Technically"})},{type:"button",text:"Quickstart",icon:"fas fa-bolt",action:()=>kiss.router.navigateTo({anchor:"Quickstart"})},{type:"button",text:"Coding style",icon:"fas fa-thumbs-up",action:()=>kiss.router.navigateTo({anchor:"Coding style"})},{type:"button",text:"About the author's beliefs",icon:"fas fa-eye",action:()=>kiss.router.navigateTo({anchor:"About the author's beliefs"})},{type:"button",text:"UI Components",icon:"fas fa-cube",iconColor:"#8c4bff",action:()=>kiss.router.navigateTo({section:"components",anchor:"Introduction about KissJS components"})},{type:"button",text:"UI Datatables",icon:"fas fa-table",iconColor:"#8c4bff",action:()=>kiss.router.navigateTo({section:"datatables",anchor:"Introduction about KissJS datatables"})},{type:"button",text:"UI Containers",icon:"far fa-clone",iconColor:"#8c4bff",action:()=>kiss.router.navigateTo({section:"containers",anchor:"Introduction about KissJS containers"})},{type:"button",text:"Tutorials",icon:"fas fa-user-graduate",iconColor:"#bb22ff",action:()=>kiss.router.navigateTo({section:"tutorials"})},{type:"button",text:"<b><u>API DOCUMENTATION</u></b>",color:"#8aa2c8",icon:"fas fa-coffee",action:()=>document.location="./doc/out/kiss.html"}]})}});kiss.app.defineView({id:"start",renderer:function(id,target){return createBlock({id:id,target,fullscreen:true,width:"100%",margin:"auto",layout:"vertical",items:[{id:"site-topbar",items:[{type:"view",id:"topbar"}]},{flex:1,layout:"horizontal",items:[{id:"site-west",class:"navigation-panel",height:"100%",layout:"vertical",items:[{type:"view",id:"logo",},{id:"site-navigation",overflowY:"auto"}]},{id:"site-content",flex:1,height:"100%",overflowY:"auto"}]}],subscriptions:{EVT_ROUTE_UPDATED:(msgData)=>{if(kiss.router.getRoute().ui=="start"){let newSection=msgData.section
...
$("code-example").setAnimation({name:"jello",speed:"slow"})}}]}]})}});kiss.app.defineView({id:"landing_features",renderer:function(id,target){return createBlock({id:id,target,width:"100%",height:500,margin:"0px 0px 50px 0px",defaultConfig:{padding:"32px",margin:"0px 32px 0px 32px",background:"#ffffff",borderRadius:"10px",boxShadow:"0px 0px 20px #cccccc"},layout:"horizontal",items:[{flex:1,type:"html",html:"HELLO"},{flex:1,type:"html",html:"WORLD"}]})}});kiss.app.defineView({id:"landing-hero",renderer:function(id,target){return createBlock({id:id,target,layout:"vertical",alignItems:"center",animation:"rotateIn",height:"100%",items:[{type:"spacer",flex:1},{type:"html",flex:1,html:`<div class="spacer"></div>
                            <div class="home-title">KISS JS</div>
                            <div class="home-pitchline">Simple Javascript UI library</div>`.removeExtraSpaces()},{defaultConfig:{color:"#ffffff",fontSize:"2.5vh",icon:"fas fa-chevron-down",iconHover:"fas fa-paper-plane",iconSize:"2.5vh",iconColor:"#ffffff",margin:"5% 0% 0% 0%",padding:"3vh 1vh",height:"5vh",borderWidth:"1px",borderRadius:"6vh",animation:"zoomIn",minWidth:"20vw"},layout:"horizontal",flexWrap:"wrap",justifyContent:"center",width:"100%",items:[{type:"button",text:"Quick overview",backgroundColor:"#2e1d80",backgroundColorHover:"#4e3da0",action:()=>{$("code-example").scrollIntoView({behavior:"smooth"})
if(!$("demo-panel"))kiss.views.show("demo-panel")}},{type:"spacer",width:"2vh"},{type:"button",text:"Datatable and forms",backgroundColor:"#00aaee",backgroundColorHover:"#30dafe",action:()=>{kiss.router.navigateTo({ui:"start",section:"datatables"})}},{type:"spacer",width:"2vh"},{type:"button",text:"Quick guide",backgroundColor:"#8c4bff",backgroundColorHover:"#bc7bff",action:()=>{kiss.router.navigateTo({ui:"start",section:"home"})}},{type:"spacer",width:"2vh"},{type:"button",text:"API documentation",backgroundColor:"#ed3757",backgroundColorHover:"#ff5777",action:()=>document.location="./doc/out/kiss.html"}]},{type:"spacer",flex:1}]})}});kiss.app.defineView({id:"landing-page",renderer:function(id,target){return createBlock({id:id,target,fullscreen:true,overflowY:"auto",items:[{type:"view",id:"landing-hero"},{type:"view",id:"landing-sample-code"}],methods:{load:function(){$("demo-code").innerHTML=texts.showPanelConfig
...
if($("demo-panel").isHidden())$("demo-panel")?.show().setAnimation("zoomIn")}else{if($("demo-panel")&&!$("demo-panel").isHidden())$("demo-panel").hide()}}}}})}});kiss.app.defineView({id:"landing-sample-code",renderer:function(id,target){texts.showPanelConfig=`<span id="help-simple-api" class="code-help">createPanel</span>({
        id: "demo-panel",
